...
<nav class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div class="content">
            <div class="content-meeting-room">
                ...
                <table class="layui-hide" id="hotel" lay-filter="hotel-table"></table>
    ...
    <div class="layui-form layui-form-pane" id="hotel-save" lay-filter="hotel-save" style="display: none">
        <div class="layui-form-item" style="display: none">
            <label class="layui-form-label">宾馆ID</label>
...
<script>
    ...
    layui.use(['element', 'table', 'form', 'layer'], function () {
        ...
        var tableObj = table.render({
            ...
            cols: [[
                {field: 'id', title: '宾馆ID', width: 130, sort: true, fixed: 'left'},
                {field: 'name', title: '名称', minWidth: 150},
                {field: 'location', title: '地址', width: 310},
        ...
        //监听行工具事件
        table.on('tool(hotel-table)', function (obj) { // 注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            var layEvent = obj.event,
                tableData = obj.data; // 获得 lay-event 对应的值
            if (layEvent === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    Ax.rest("/admin/hotel/remove", tableData.id, function (data) {
        ...
        form.on('submit(save)', function(formData){
            Ax.rest("/admin/hotel/save", formData.field, function (data) {
                location.reload();
            })
        });
